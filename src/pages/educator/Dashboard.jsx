...
export default function Dashboard() {
  ...
  return dashboardData ? (
    <div className="p-3 md:p-5 lg:p-10">
      <div className="flex flex-col max-sm:w-full w-fit md:flex-row gap-5 flex-wrap md:justify-center lg:justify-start items-center max-sm:text-xs">
        <div className="flex justify-center gap-5 border-2 border-gray-300 p-7 rounded-lg">
          ...
          />
          <div>
            <h1 className="max-sm:text-xl text-3xl">
      ...
      <div className="flex flex-col items-center h-full overflow-hidden rounded-sm border border-gray-500/20 mt-3">
        <table className="w-full md:table-auto overflow-hidden">
          <thead className="text-gray-900 border-b border-gray-500/20 max-sm:text-xs">
            <tr>
          ...
          <tbody className="text-sm text-gray-500">
            {dashboardData.enrolledStudentsData.map((item, idx) => (
              <tr key={idx} className="border-b border-gray-200 max-sm:text-xs">
    ...
    //   Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio minus quam
    //   sequi officia, nobis, repellendus repudiandae voluptate atque quae,
    //   exercitationem voluptatum incidunt labore enim esse laboriosam sit optio
    //   voluptas laborum.
    // </div>
    <Loading />
  );
